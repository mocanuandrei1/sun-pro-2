...
const ServiciiBlockModel1 = ({
  ...
  return (
    <section className={"my-28 " + backgroundColor}>
      <div
        ...
        >
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              <li className="flex items-center gap-2 flex-wrap">
                <TbCircleNumber1Filled className="text-xl text-custom-orange" />
                <span className="font-semibold">{thirdH3Text[0].title}</span>
                {thirdH3Text[0].text}
              </li>
              <li className="flex items-center gap-2 flex-wrap">
                <TbCircleNumber2Filled className="text-xl text-custom-orange" />
                <span className="font-semibold">{thirdH3Text[1].title}</span>
                {thirdH3Text[1].text}
              </li>
              {thirdH3Text[2] && (
                <li className="flex items-center gap-2 flex-wrap">
                  <TbCircleNumber3Filled className="text-xl text-custom-orange" />
                  <span className="font-semibold">{thirdH3Text[2].title}</span>
                  {thirdH3Text[2].text}
                </li>
              )}
            </ul>
